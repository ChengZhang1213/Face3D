...
#ifndef FACE3D_ANDROID_UTILS_H
#define FACE3D_ANDROID_UTILS_H
...
using namespace cv;
static void  bitmap_to_mat(JNIEnv *env, jobject &srcBitmap, Mat &srcMat) {
    void *srcPixels = 0;
...
static void mat_to_bitmap(JNIEnv *env, Mat &srcMat, jobject &dstBitmap) {
    void *dstPixels = 0;
